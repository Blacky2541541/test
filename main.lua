...
InstaKillButton.Position = UDim2.new(0, 50, 0, 260)
...
-- Teleport Player to Me Button
local TPButton = Instance.new("TextButton")
TPButton.Parent = MainFrame
TPButton.Size = UDim2.new(0, 200, 0, 30)
TPButton.Position = UDim2.new(0, 50, 0, 300)
...
ATMFarmButton.Position = UDim2.new(0, 50, 0, 340)
...
InvisibilityButton.Position = UDim2.new(0, 50, 0, 380)
...
DanceButton.Position = UDim2.new(0, 50, 0, 460)
...
TPListTitle.TextColor3 = Color3.new(1, 1, 0)
...
TPScrollingFrame.ScrollBarImageColor3 = Color3.new(1, 1, 0)
...
local function startDance()
    ...
    danceAnim.AnimationId = "rbxassetid://507777136"
...
local function createOrUpdateTPPlayerButton(player)
    ...
    if tpTargetPlayer == player then
        button.BackgroundColor3 = Color3.new(0.5, 0.5, 0)
...
PlayerScrollingFrame.ChildAdded:Connect(function(child)
    if child:IsA("TextButton") then
        child.MouseButton1Click:Connect(function()
            local playerName = child.Text:gsub(" %[FOLLOWING%]", "")
...
TPScrollingFrame.ChildAdded:Connect(function(child)
    if child:IsA("TextButton") then
        child.MouseButton1Click:Connect(function()
            local playerName = child.Text:gsub(" %[%w+%]", "")
            local player = Players:FindFirstChild(playerName)
            if player then
